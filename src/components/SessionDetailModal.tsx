      ...
      >
        ...
        <div className="p-6 sm:p-8 bg-slate-900 text-white relative">
          ...
          <div className="flex items-center space-x-2 mb-2">
            <span className="text-[11px] font-mono font-bold uppercase tracking-wider text-teal-300 bg-teal-950 border border-teal-800/80 px-2.5 py-0.5 rounded">
              {session.session_code}
            </span>
            <span className="text-xs text-slate-400">• Track: {session.track}</span>
          </div>
        ...
        <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-5 py-2.5 bg-teal-600 hover:bg-teal-500 text-white rounded-xl text-xs font-semibold shadow-md transition-colors"
          >
